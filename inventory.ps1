...
Set-Content -Path $conf.tempcsv -Value '"CallingAE","InstitutionName","Manufacturer","ManufacturerModelName","StationName","Modality","SOPClassUID","SoftwareVersions"',"DeviceSerialNumber","SpartialResolution","DateofLastCalibration","TimeofLastCalibration","PixelPaddingValue"
...
import-csv -path $conf.tempcsv | sort CallingAE,InstitutionName,Manufacturer,ManufacturerModelName,StationName,Modality,SOPClassUID,SoftwareVersions,DeviceSerialNumber,SpatialResolution,DateofLastCalibration,TimeofLastCalibration -Unique  | export-csv -path $conf.outcsv
